...
//     public DriveSubsystem(Spark[] leftNeos,
// Spark[] rightNeos, boolean isRightInverted, double deadband) {

//         m_left = new MotorControllerGroup(leftNeos);
//         m_right = new MotorControllerGroup(rightNeos);

//         m_left.setInverted(!isRightInverted);
//         m_right.setInverted(isRightInverted);
...
//         m_left.set(leftProportion);
//         m_right.set(rightProportion);
//     }
    ...
    // }
    // private WPI_TalonSRX m_leftFalconMaster;
    // private WPI_TalonSRX m_rightFalconMaster;

    // private WPI_TalonSRX[] m_leftFalconFollowers;
    // private WPI_TalonSRX[] m_rightFalconFollowers;

    // double m_deadband;

    // public DriveSubsystem(WPI_TalonSRX leftFalconMaster, WPI_TalonSRX[] leftFalconFollowers,
    //         WPI_TalonSRX rightFalconMaster,
    //         WPI_TalonSRX[] rightFalconFollowers, boolean isRightInverted, double deadband) {
    //     m_leftFalconMaster = leftFalconMaster;
    //     m_rightFalconMaster = rightFalconMaster;
    ...
    //     for (WPI_TalonSRX follower : m_leftFalconFollowers) {
    //         follower.configFactoryDefault();
    //         follower.setInverted(!isRightInverted);
    //         follower.setNeutralMode(NeutralMode.Brake);
    //         follower.follow(m_leftFalconMaster, FollowerType.PercentOutput);
    ...
    //     for (WPI_TalonSRX follower : m_rightFalconFollowers) {
    //         follower.configFactoryDefault();
    //         follower.setInverted(isRightInverted);
    //         follower.setNeutralMode(NeutralMode.Brake);
    //         follower.follow(m_rightFalconMaster, FollowerType.PercentOutput);
